...
from utils.helper_girls_imgaug import random_patch, random_imaug
...
class TightFaceProvider_Wally_Girl(Sequence):
    """
    ...
    def __getitem__(self, index):
        ...
        batch_xs = np.concatenate([aug_fg_imgs, girl_bg_imgs], axis=0)
        # batch_ys에는 background, foreground의 라벨들이 들어간다.
        batch_ys = np.concatenate([aug_fg_labs, girl_bg_labs], axis=0)
