...
from augmentator import apply_aug
from helper import paths2pil, pil2numpy, resize_images, images_cropper, rect2square, video2image, paths2numpy
...
class VideoTrainProvider(object):
    ...
    def __init__(self, fg_folder, bg_folder, resize):
        ...
        self.bg_imgs = images_cropper(bg_imgs, 30, 30, 120, 120)
...
class VideoValidationProvider(object):
    ...
    def __init__(self, fg_folder, bg_folder, stride_size, crop_size):
        ...
        self.bg_imgs = images_cropper(self.bg_imgs, stride_size[0], stride_size[1], crop_size[0], crop_size[1])
...
if __name__ == '__main__':
    ...
    train_bg_folder = './images/block_imgs_sample'
